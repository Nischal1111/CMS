...
public class StudentIDEditMarks extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	StudentIDEditMarks frame = new StudentIDEditMarks();
    ...
    public StudentIDEditMarks() {
        ...
        btnGo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                EditMarks editMarksFrame = new EditMarks(studentId);
